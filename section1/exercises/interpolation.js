...
// Your answer and explanation here: A string because it interpolation multiple strings.
...
var activity = "sport";
var name = "Jake"
console.log(`One ${activity} that ${name} never played in school was ${sport}`)
