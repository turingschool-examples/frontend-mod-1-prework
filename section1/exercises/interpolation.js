...
// This will log the string "My zoo has 7 unicorns!" This is the product of type coercion.
...
var videoGame = "Nioh 2";
var gamingExperience = "rage inducing";

console.log(`The ${difficulty} difficulty setting in ${videoGame} is ${gamingExperience}!`);
