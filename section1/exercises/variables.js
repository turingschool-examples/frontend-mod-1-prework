...
var banish = "Harry Potter must not return to Hogwarts!";
console.log(banish);
...
/*- I used a _string_ for the `firstName` becuase of the characters used for the answer have letters.
  - I used a _boolean type_ for `isHungry` becuase we are asking a yes or no question
  - I used a _number_ for `numberOfPets` becasue the answer is a number.*/
