...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
  /* I used a string to enter my name, since it requires text. I used a Boolean data
  for isHungry because that seemed like a yes/no question. I used an integer for numberOfPets
