...
// How did you decide to use the data type you did for each of the three variables above?
  ...
  //for the first, it's a name, so text, which is a string. the isHungry seems like a Boolean because it can be either true or false. For the last, it has number in the name, so it's a number.
