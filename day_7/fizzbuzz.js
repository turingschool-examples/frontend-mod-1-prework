...
// We run this statement first because the condition is more specific than the two below it.
if (i%3 === 0 && i%5 === 0) {
...
// in case the if statement and the first else if statment are false.
