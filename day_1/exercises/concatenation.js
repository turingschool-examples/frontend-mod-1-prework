...
console.log("When string and number data types are concatenated, the resulting data type logged is a string")
...
var slowPoke2 = "tortoise";
var speedy2 = "hare";

console.log ("In a predictable result, the " + slowPoke2 + " beat the" + speedy2);
