...
// Javascript helps us by converting the number into a sting
var number = 7;
...
console.log("The " + speedy + " jumped over the " + slowPoke);/*YOUR CODE HERE*/);
...
speedy = "hare";
 ...
 console.log("In a predictable result, the " + slowPoke + " beat the " + speedy + "!")// YOUR CODE HERE
