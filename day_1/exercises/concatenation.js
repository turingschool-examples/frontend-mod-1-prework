...
var ans2 = "-----Question 1: In concatenation (join together)the other data types and string all become a string due to type coercion. A string is logged when we run the the code below.------";
console.log(ans2);
