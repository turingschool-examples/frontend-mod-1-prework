...
than 'coat':
var weather = 'sunny'
This would then give you "sunscreen" as the return value instead of "coat". (I ran it in my terminal and got back sunscreen!) * the code will over write snowy with sunny after I assigned weather with a new string.
----------------------------
...
if (numQuarters == 0) {
  console.log("I don't have enough money for the gumball");
} else if (numQuarters == 1) {
  console.log("I don't have enough money for the gumball");
} else if (numQuarters == 2) {
  console.log("I have enough money for a gumball");
} else if (numQuarters == 3) console.log("I have enough money for a gumball");
...
} else if (cupsOfFlour == 3 && hasSauce == true) console.log("I can make pizza");
