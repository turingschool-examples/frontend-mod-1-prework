...
1. Border vs. margin vs. padding:
  1.1 Border: The border separates the edge of one box from another.
  1.2 Margin: Margins sit outside the edge of the border. You can set the width of the margin top create a gap between the borders of two adjacent boxes.
  1.3 Padding: The space between the border of a box and any content contained within it.
