...
var foods = ["Burger", "Pizza", "French Fry", "Tator Tot"];
console.log(foods);// YOUR CODE HERE
...
// foods from above.
console.log(foods.length);// YOUR CODE HERE
