...
var foods = ["banana", "peach", "pear", "plum"];
console.log(foods);

// example: Write code below that will log the number of elements
//in array of animals from above.
console.log(animals.length);

// Write code below that will log the number of elements in the
//array of foods from above.
console.log(foods.length);

// Write code below that will log "Zebra" from the animals array
console.log(animals.shift());

// Write code using bracket notation that will log the first item
