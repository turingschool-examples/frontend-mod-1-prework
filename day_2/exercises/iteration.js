...
var foods = ["garbanzo beans", "lemons", "tahini", "garlic"];
...
var numbers = [0, 1, 1, 2, 3, 5, 8, 13]

for (var i = 0; i < numbers.length; i++) {
  console.log((numbers[i] * 2) + " or " + (numbers[i]) + (numbers[i]));
}
// Logged as such because I am not quite sure how to read the question - tried to answer for both ways.
