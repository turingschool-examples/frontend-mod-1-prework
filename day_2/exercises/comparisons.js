...
// xexample: log the result of the comparison: is firstVar greater than secondVar?
console.log(firstVar > secondVar); // this should return: false

// xlog the result of the comparison: is firstVar less than secondVar?
console.log(firstVar < secondVar); // this should return: true

// xlog the result of the comparison: is firstVar equal to thirdVar? (use the == operator)
...
// Xlog the result of the comparison: is firstVar strictly equal to thirdVar? (use the === operator)
...
// Xlog the result of the comparison: is firstVar not equal to secondVar?
console.log(firstVar !== secondVar); // this should return: true

// Xlog the result of the comparison: is secondVar greater than or equal to 20?
console.log(secondVar >= 20 ); // this should return: true

// Xlog the result of the comparison: is secondVar greater than or equal to 21?
console.log(secondVar >= 21); // this should return: false

// Xlog the result of the comparison: is secondVar less than or equal to 20?
console.log(secondVar <= 20); // this should return: true

// Xlog the result of the comparison: is secondVar less than or equal to 21?
