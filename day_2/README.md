...
1. Sometimes we have a collection of data (like an array) and we want to do something to each item in the collection. In these instances, we need to **loop** through each piece of data in our collection.
