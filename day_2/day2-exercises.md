...
3. What attribute should you include in a link to open a new tab when the link is clicked?<br />
 <p>The attribute is known as target and it cause the link to open in a new tab or window. <code>ex:<a href= "https://www.imdb.com/title/tt0347149/?ref_=nv_sr_1?ref_=nv_sr_1" target="blank"> Amazing Movie</a></code></p>
