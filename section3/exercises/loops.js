...
// EXPLAIN:
//the value of i will be logged, so 0 1 2. This is becuase i starts at zero and the for loop stops before it prints 3 as 3 < 3 returns false.

 // YOU DO: Write code below that logs to the console, the sum of 2 plus 2, 7 times:
for (var i = 0; i < 7; i++) {
  console.log("The sum of two plus two is " + (2+2) + ".");
};
