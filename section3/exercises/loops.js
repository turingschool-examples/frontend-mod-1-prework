...
// EXPLAIN:
//
// 0 , 1 , 2 on seperate lines
// The intialization starts the variable (i) at 0.
// The condition states that the interpreter runs as long as "i" < 3.
// (i) is updated with the `i++` instruction, increasing by one each time.
