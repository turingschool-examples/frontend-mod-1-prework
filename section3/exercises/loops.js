...
// EXPLAIN: The second example logs the index on the count rather than displaying a string message. Since the index statement starts at 0 and the condition is
// less than 3, with i++ indicating each time i is logged, it will increase by one integer.
